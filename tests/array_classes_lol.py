...
linkml_meta = LinkMLMeta(
    {
        "default_prefix": "https://example.org/arrays/",
...
class Container(ConfiguredBaseModel):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {"from_schema": "https://example.org/arrays", "tree_root": True}
    )
    ...
    temperature_dataset: TemperatureDataset = Field(
        ...,
        json_schema_extra={
            "linkml_meta": {"alias": "temperature_dataset", "domain_of": ["Container"]}
        },
    )
    latitude_series: LatitudeInDegSeries = Field(
        ...,
        json_schema_extra={"linkml_meta": {"alias": "latitude_series", "domain_of": ["Container"]}},
    )
    longitude_series: LongitudeInDegSeries = Field(
        ...,
        json_schema_extra={
            "linkml_meta": {"alias": "longitude_series", "domain_of": ["Container"]}
        },
    )
...
class TemperatureDataset(ConfiguredBaseModel):
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            "from_schema": "https://example.org/arrays",
    ...
    latitude_in_deg: str = Field(
        ...,
        json_schema_extra={
            "linkml_meta": {"alias": "latitude_in_deg", "domain_of": ["TemperatureDataset"]}
        },
    )
    longitude_in_deg: str = Field(
        ...,
        json_schema_extra={
            "linkml_meta": {"alias": "longitude_in_deg", "domain_of": ["TemperatureDataset"]}
        },
    )
    date: DateSeries = Field(
        ...,
        json_schema_extra={"linkml_meta": {"alias": "date", "domain_of": ["TemperatureDataset"]}},
    )
    day_in_d: Optional[DaysInDSinceSeries] = Field(
        None,
        json_schema_extra={
            "linkml_meta": {"alias": "day_in_d", "domain_of": ["TemperatureDataset"]}
        },
    )
    temperatures_in_K: TemperaturesInKMatrix = Field(
        ...,
        json_schema_extra={
            "linkml_meta": {"alias": "temperatures_in_K", "domain_of": ["TemperatureDataset"]}
        },
    )
...
class DaysInDSinceSeries(ConfiguredBaseModel):
    ...
    reference_date: str = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"alias": "reference_date", "domain_of": ["DaysInDSinceSeries"]}
        },
    )
    ...
    values: List[List[List[float]]] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {
                "alias": "values",
                "array": {
                    "dimensions": [{"alias": "x"}, {"alias": "y"}, {"alias": "date"}],
